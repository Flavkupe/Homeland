...
namespace WindowsGame1
{
  ...
  public class UserInterfaceDemoGame : Microsoft.Xna.Framework.Game {
    ...
    public UserInterfaceDemoGame() {
         ...
         //Content.Load<Texture2D>("Images/Elf");
    ...
    protected override void Initialize() {
      ...
      mypic = new Texture2D(graphics.GraphicsDevice, 100, 100);
    ...
    protected override void Update(GameTime gameTime) {
      ...
      ////////////////////////////// FOR WIN PHONE: "CONVERT" FINGER TAPS TO NUCLEX MOUSE CLICKS ////////////////////////////////////////////
      ...
      //            this.gui.InputCapturer.InputReceiver.InjectMouseMove(gesture.Position.X, gesture.Position.Y);
      //            this.gui.InputCapturer.InputReceiver.InjectMousePress(Nuclex.Input.MouseButtons.Left);
      //            break;
      //    }
      //}
      //else
      //{
      //    this.gui.InputCapturer.InputReceiver.InjectMouseRelease(Nuclex.Input.MouseButtons.Left);
      //}
      ///////////////////////////////////////////////////////////////
