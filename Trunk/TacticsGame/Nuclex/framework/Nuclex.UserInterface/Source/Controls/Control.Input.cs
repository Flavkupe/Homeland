...
namespace Nuclex.UserInterface.Controls {
  ...
  partial class Control {
    ...
    internal bool ProcessMousePress(MouseButtons button, bool insideModalControl = false) 
    {
      // Flavio
      if (this.ModalZOrder < ModalZ && !this.IgnoresModality)
      {
          return false; // ignore control if modality is set
      }
    ...
    internal void ProcessMouseWheel(float ticks) {
      ...
      if(this.mouseOverControl != null) {
        if(this.mouseOverControl != this && !((this is IStealsMouseWheelInput && ((IStealsMouseWheelInput)this).StealsInput))) {
