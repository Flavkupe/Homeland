...
namespace Nuclex.UserInterface.Controls.Desktop {
  ...
  public class ListControl : Control, IFocusable {
    ...
    protected void itemsCleared(object sender, EventArgs arguments) {
      updateSlider();
    }
    ...
    protected void selectionAdded(object sender, ItemEventArgs<int> arguments) {
      OnSelectionChanged();
    }
    ...
    protected void selectionRemoved(object sender, ItemEventArgs<int> arguments) {
      OnSelectionChanged();
    }
    ...
    /// <param name="arguments">Not Used</param>
    protected void selectionCleared(object sender, EventArgs arguments) {
      OnSelectionChanged();
    }
