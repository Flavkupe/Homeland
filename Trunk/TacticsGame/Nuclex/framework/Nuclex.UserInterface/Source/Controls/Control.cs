...
namespace Nuclex.UserInterface.Controls {
  ...
  public partial class Control {
    ...
    public bool AffectsOrdering {
      ...
      set { this.affectsOrdering = value; }  
    }
    ...
    public int ModalZOrder
    {
        get { return this.zOrder; }
        set { this.zOrder = value; }
    }

    public virtual bool IgnoresModality { get { return false; } }
    ...
    /// <summary>
    /// Flavio.
    /// If set to something greater than 0, will ignore all dialogs whose Z order is less than this. Use to set modal dialogs.
    /// </summary>
    public static int ModalZ = 0;
    ...
    /// <summary>
    /// Hides or shows the control by adding it or removing it to this control's children if it's not already there.
    /// </summary>
    /// <param name="control"></param>
    /// <param name="visibility"></param>
    public virtual void SetControlVisible(Control control, bool visibility)
    {
        if (!visibility && this.Children.Contains(control))
        {
            this.Children.Remove(control);
        }
        else if (visibility && !this.Children.Contains(control))
        {
    ...
    protected virtual void OnMouseLeft() 
    {
        ...
        {
            this.MouseLeft(this, new EventArgs());
        }
    }
    ...
    protected virtual void OnMouseEntered() 
    {
        ...
        {
            this.MouseEntered(this, new EventArgs());
        }
    }
    ...
    internal void SetParent(Control parent) {
      ...
      {
        // Flavio
        if (parent.ModalZOrder > this.ModalZOrder)
        {
            this.ModalZOrder = parent.ModalZOrder;
            foreach (Control child in this.Children)
            {
                child.ModalZOrder = parent.ModalZOrder;
            }
        }
